...
pub const BRIGHTNESS_RESPONSE: Payload = payload(
    &[
        ...
        f(
            ...
            FieldKind::U8,
            true,
            "Backlight value, inverted Car Thing scale 1..255.",
        ),
    ],
    r#"{"auto":true,"brightness":180}"#,
...
pub const METHOD_INVENTORY: &[Method] = &[
    method(
        ...
        payload(
            ...
            r#"{"payload":[{"address":"AA:BB:CC:DD:EE:FF","blocked":false,"default":true,"connected":true,"device_info":{"name":"iPhone"}}],"type":"bluetooth_device_list"}"#,
        ...
        payload(
            &[
                ...
                f(
                    ...
                    FieldKind::U8,
                    false,
                    "Optional RFCOMM channel hint; current daemon auto-detects.",
                ),
            ],
        ...
        payload(
            &[
                f(
                    ...
                    FieldKind::String,
                    true,
                    "connected or waiting_for_android.",
                ),
    ...
    method(
        ...
        payload(
            ...
            r#"{"device":"Nocturne (1234)","version":"2.0.4","full_version":"v2.0.4","build_date":"2026-05-28","git_hash":"abc123","serial_number":"SERIAL1234"}"#,
    ...
    method(
        ...
        payload(
            ...
            r#"{"datetime":"2026-05-28T20:00:00Z"}"#,
            "Phone time response.",
        ),
    ...
    method(
        ...
        payload(
            ...
            r#"{"content_id":"playlist123","limit":50,"offset":0}"#,
...
pub const EVENT_INVENTORY: &[Event] = &[
    event(
        ...
        payload(
            ...
            r#"{"datetime":"2026-05-28T20:00:00Z","timezone":{"identifier":"America/Los_Angeles"},"platform":"ios","subscribed":true,"subscription_status":"active","has_lifetime":false,"spotify_skipped":false}"#,
    ...
    event(
        ...
        payload(
            ...
            r#"{"subscribed":true,"subscription_status":"active","has_lifetime":false}"#,
    ...
    event(
        ...
        payload(
            ...
            r#"{"id":"sub-expiry-3","title":"Nocturne+ expires soon","body":"Renew to keep features","category":"subscription","days_until_expiry":3,"timestamp":1713000000000}"#,
            "Notification event.",
        ),
        "Phone-pushed UI notification.",
    ),
    event(
        "bluetooth.agent",
        Family::Bluetooth,
        ...
        payload(
            &[
                f(
                    ...
                    FieldKind::String,
                    true,
                    "connecting, connection_established, or connection_closed.",
                ),
                f("device", FieldKind::String, true, "Device address."),
                f(
                    "connection_type",
    ...
    event(
        ...
        payload(
            ...
            r#"{"transcript":"play some music","is_final":true}"#,
    ...
    event(
        ...
        payload(
            ...
            r#"{"tool_name":"spotify.play","result":{"ok":true}}"#,
    ...
    event(
        ...
        payload(
            ...
            r#"{"media_item_attributes":{"media_item_title":"Song","media_item_artist":"Artist"},"playback_attributes":{"playback_status":"playing"}}"#,
    ...
    event(
        ...
        payload(
            ...
            r#"{"data":"/9j/4AAQ","content_type":"image/jpeg"}"#,
            "Artwork event.",
        ),
    ...
    event(
        ...
        "Current brightness hot file emits this UI-only event; not in prior audit list.",
    ),
    event(
        "daemon.ready",
        Family::BtOnly,
