...
pub const METHOD_INVENTORY: &[Method] = &[
    ...
    method(
        ...
        "Recover the current pairing prompt after UI reconnect.",
    ),
    method(
    ...
    method(
        ...
        EMPTY_PAYLOAD,
        STATUS_OK_RESPONSE,
        "Sends the source-aware HID Promote control.",
    ),
    method(
        ...
        EMPTY_PAYLOAD,
        STATUS_OK_RESPONSE,
        "Sends the source-aware HID Demote control.",
    ),
    method(
    ...
    method(
        ...
        payload(
            &[f(
                ...
                FieldKind::StringArray,
                true,
                "Spotify track ids or complete spotify:local: URIs.",
            )],
            r#"{"ids":["track123"]}"#,
...
pub const EVENT_INVENTORY: &[Event] = &[
        ...
        payload(
            &[
                ...
                f(
                    ...
                    FieldKind::Bool,
                    false,
                    "Agent authorization result.",
                ),
                f(
                    "request_id",
                    FieldKind::String,
                    false,
                    "Pairing challenge identifier for scoped user decisions and cancellation.",
                ),
            ],
    ...
    event(
        ...
        payload(
            ...
            r#"{"media_item_attributes":{"media_item_title":"Song","media_item_artist":"Artist"},"playback_attributes":{"playback_status":"playing","PlaybackAppName":"YouTube Music"},"media_generation":7}"#,
        ...
        payload(
            &[
                ...
                fs(
                    ...
                    FieldKind::Bool,
                    false,
                    "Whether capture audio has already undergone noise suppression.",
                ),
            ],
            r#"{"sample_rate":16000,"channels":1,"frame_ms":60,"noise_suppressed":true}"#,
