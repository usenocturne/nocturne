...
/** @typedef {import("@schema/spotify").SpotifyPlayerPauseRequest} SpotifyPlayerPauseRequest */
/** @typedef {import("@schema/voice").TtsSpeakRequest} TtsSpeakRequest */
/** @typedef {import("@schema/device").OnboardingSetStateRequest} OnboardingSetStateRequest */
...
class OnboardingStore {
  ...
  pause() {
    sendNocturneWsRequest(
      ...
      /** @type {SpotifyPlayerPauseRequest} */ {},
    ).catch(() => {});
  }
  ...
  _notifyPhoneOnboarding(active) {
    ...
    sendNocturneWsRequest("onboarding.set_state", request).catch((e) => {
