...
import NightModeController from "./NightModeController";
import WindLevelStore from "./WindLevelStore";
import AirVentInterferenceController from "./AirVentInterferenceController";
...
export class RootStore {
  ...
  constructor(
    ...
    try {
      ...
      console.warn("Mockingbird hardware event bridge unavailable:", error);
    }
